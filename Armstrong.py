...
"""%s
 ...
 • Info script : 	 - author      : PANKISH XD

 - facebook    : https://www.facebook.com/armstrong.ii.7

 - whatsap     : +2348161269017

 - github      : https://github.com/PANKISH

 - script name : (Jangan Lupa Siapkan Kopi Dan rokok)
...
def banner():
 ...
 © Group%s \n __________       _____.__  \n \____    /____ _/ ____\__| %s> %s PANKISH XD \n   /     /\\__  \\\   __\|  | %s> %s XD \n  /     /_ / __ \|  |  |  | %s>%s [Meta] \n /_______ (____  /__|  |__| %s>%s CODE \n         \/    \/ \n %s[%s*%s] By : %sPANKISHXD13 \n %s[%s*%s] -------------------------------------- \n [%s*%s] IP : %s%s'''%
